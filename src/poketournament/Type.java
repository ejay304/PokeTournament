...
public class Type {
	...
	public static void init() {
		...
		steel.setResist(steel, dragon, ice, bug, normal, grass, psy, rock,
				ghost, dark, flying);
	...
	/**
	 * Permet de savoir si le type est résistant a un autre type.
	 * 
	 * @param type
	 *            le second type
	 * @return si le type est résistant au second type
	 */
	...
	/**
	 * Permet de savoir si le type est faible a un autre type.
	 * 
	 * @param type
	 *            le second type
	 * @return si le type est faible au second type
	 */
	...
	/**
	 * Permet de savoir si le type est immunisé a un autre type.
	 * 
	 * @param type
	 *            le second type
	 * @return si le type est immunisé au second type
	 */
	...
	/**
	 * Permet de récupérer le facteur de vulnérabilité (pour le calcul de
	 * dégats)
	 * 
	 * @param type
	 *            le type envers lequel on souhaite connaitre le facteur.
	 * @return le facteur
	 */
